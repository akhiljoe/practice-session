...
This repo is my personal interview preparation workspace. It contains solutions, notes, patterns, and complexity analysis for Data Structures and Algorithms problems commonly encountered in technical interviews at product companies.
...
- [ ] Solve **150+ curated problems** across all major DSA topics
- [ ] Cover all core data structures with clean, well-commented implementations
- [ ] Develop intuition for **recognizing problem patterns** under time pressure
- [ ] Maintain a personal notes layer on top of each topic (gotchas, edge cases, tricks)
- [ ] Be consistently interview-ready for **Senior / Lead-level** engineering roles
...
| Step  | Stands For | What to Do                                                            |
|-------|------------|-----------------------------------------------------------------------|
| **U** | Understand | Restate the problem. Clarify constraints, edge cases, input/output.   |
| **M** | Match      | Identify which pattern or data structure applies.                     |
| **P** | Plan       | Talk through your approach before writing code.                       |
| **I** | Implement  | Write clean, readable code. Name variables well.                      |
| **R** | Review     | Trace through with an example. Check edge cases.                      |
| **E** | Evaluate   | State time and space complexity unprompted.                           |
...
- [ ] What is the time complexity of each loop / recursive call?
- [ ] Is there hidden space cost from the recursion stack depth?
- [ ] Can this be improved with a better data structure?
- [ ] Does the solution handle empty input, single elements, and duplicates?
